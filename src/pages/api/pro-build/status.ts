// src/pages/api/pro-build/status.ts
import type { APIRoute } from 'astro';
import { processProBuildStatus } from '../../../lib/services/proBuildService.js';
...
export const GET: APIRoute = async ({ request }) => {
  ...
  const result = processProBuildStatus(champion, opponent, role, patch, allies, enemies);
